...
const Footer = () => {
  return (
    <>
      <div>
        <footer className="footer h-[105vh] sm:h-[70vh] relative flex p-10 bg-base-200 text-base-content">
          <nav>
          ...
          <form className="absolute bottom-0 sm:top-12 right-[18%] sm:right-12">
            ...
            <h6 className="footer-title">
              ...
              <div className="join">
                <input
                  type="text"
                  placeholder="Is there any Celebrity?"
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 md:flex md:items-center md:justify-between md:flex-row">
        ...
        <nav className="place-self-center md:place-self-auto md:justify-self-end">
